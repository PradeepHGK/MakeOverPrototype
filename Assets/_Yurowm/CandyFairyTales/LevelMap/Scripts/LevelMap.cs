...
namespace YMatchThree.Seasons {
    public class LevelMap : GameEntity, ISerializableID {
        [PreloadStorage]
        ...
        LevelProgressModule levelProgress;
        ...
        public override void OnAddToSpace(Space space) {
            ...
            levelProgress = App.data.GetModule<LevelProgressModule>();
            
            var worldProgress = levelProgress.GetWorldPropgress(worldName, true);
